                ...
                <div class="menu-area">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="logo-area">
                                    <a class="mt-20 light" href="/"><img src="../images/white-logo.png" alt="logo"></a>
                                    <a class="mt-20 dark" href="/"><img src="../images/logo.png" alt="logo"></a>
                                </div>
                            </div>
                                        ...
                                        <nav class="rs-menu">
                                            <ul class="nav-menu">
                                                ...
                                                <li class="menu-item-has-children">
                                                    <a href="#">Procedures</a>
                                                    <ul class="sub-menu">
                                                        <li><a href="facial-surgery.html">Facial Surgery</a></li>
                                                        <li><a href="breast.html">Breast</a></li>
                                                        <li><a href="body-contouring.html">Body Contouring</a></li>
                                                        <li><a href="complementary-treatment.html">Complementary Treatment</a></li>
                                                    </ul>
                                                </li>
        ...
        <div class="main-content pt-100">
            ...
            <div>
                <div class="container-fluid mt-100 mb-100 pt-100">
                    ...
                    <div class="row">
                        <div class="text-center col-lg-3 mt-150">
                            <h3>Dr. Héctor Cantú</h3>
                            <p><b>Email:</b> plasticsurgerycabodr@gmail.com</p>
                            <h3>BlueNet Hospital</h3>
                            <p><b>Phone:</b>+52 (624) 157 36 74</p>
                        ...
                        <div class="col-lg-5 pr-30 mt-100">
                            <div class="contact-wrap">
                                <div class="sec-title mb-50">
                                    <h2 class="title mb-33 text-center">Valuation appointments</h2>
                                    <a class="text-center" target="_blank" href="https://wa.me/+526241573674?text=Hola%20me%20gustaría%20agendar%20una%20cita."><p style="text-decoration:underline;">Contact Us by WhatsApp</p></a>
                                </div>
                                <form class="contact-inner-page" action="/php/contacto1.php" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <label for="">Subject*</label>
                                            <input class="form-control mb-10" type="text" name="asunto" placeholder="Subject">
                                        </div>
                                        
                                        <div class="col-md-6">
                                            <label for="">Interest</label>
                                            <select class="form-control mb-20" name="interes" id="">
                                        ...
                                        <div class="col-md-12">
                                            <textarea class="mb-50 form-control" rows="5" placeholder="Message" name="mensaje" required></textarea>
                    ...
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-lg-12 mt-50 mb-80">
                            <div class="copyright text-center">
                                <p>&copy; 2020 Powered by <a target="_blank" class="text-white" href="http://bananagroup.mx">Banana Group</a></p>
                            </div>
                        </div>
                    </div>
                </div>
